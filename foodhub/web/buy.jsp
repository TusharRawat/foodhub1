...
<div id="faltu">
  ...
  <%
   ...
   category c=cd.getCategory(cart_id);
                        ...
                        <div class="panel-body">
                            <div class="form-group">
                                ...
                                <div class="col-sm-3 col-xs-3">
                                    <img class="img-responsive" src="<%=c.getImage()%>" />
                                    <input type="hidden" value="<%=c.getId()%>" name="items">
                                </div>
                                <div class="col-sm-6 col-xs-6">
                                    <div class="col-xs-12"><%=c.getUsername()%></div>
                                    <div class="col-xs-12"><small><%=c.getDescription()%></small></div>
                            ...
                            <div class="form-group">
                                <div class="col-xs-12">
                                    ...
                                    <div class="pull-right"><span>₹</span><%=c.getPrice()%> <span></span></div>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="panel-body">
                            <div class="form-group">
                              ...
                              <div id="locationField">
                                  <input id="autocomplete" name="address" required="" placeholder="Enter your address"
...
<br>
      ...
      <tr>
        ...
        <center>	<div class="btn btn-info" id="back"><span class="glyphicon glyphicon-chevron-left"></span> CONTINUE SHOPPING</div>
